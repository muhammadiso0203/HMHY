    ...
    <div>
      ...
      <div className="bg-white rounded-2xl shadow p-6 mt-7">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <button onClick={() => navigate("/app/admin/teachers")} className="bg-blue-50 rounded-2xl p-6 flex flex-col items-center gap-2 hover:bg-blue-100">
            <Users className="w-6 h-6 text-blue-600" />
            <span className="font-medium">Ustozlar</span>
          </button>

          <button onClick={() => navigate("/app/admin/students")} className="bg-green-50 rounded-2xl p-6 flex flex-col items-center gap-2 hover:bg-green-100">
            <GraduationCap className="w-6 h-6 text-green-600" />
            <span className="font-medium">Talabalar</span>
          </button>

          <button onClick={() => navigate("/app/admin/lessons")} className="bg-purple-50 rounded-2xl p-6 flex flex-col items-center gap-2 hover:bg-purple-100">
            <BookOpen className="w-6 h-6 text-purple-600" />
            <span className="font-medium">Darslar</span>
          </button>

          <button onClick={() => navigate("/app/admin/payments")} className="bg-yellow-50 rounded-2xl p-6 flex flex-col items-center gap-2 hover:bg-yellow-100">
